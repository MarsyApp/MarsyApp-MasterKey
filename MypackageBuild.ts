...
const pathToMods = "C:\\games\\EFT_3.5.8\\MODS\\MarsyApp-MasterKey\\user\\mods"
...
fs.copySync(path.normalize(`${__dirname}/${modName}`), path.normalize(`${pathToMods}/MarsyApp-MasterKey`));
